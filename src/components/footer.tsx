import { ChartCandlestick, Scale } from "lucide-react";
    ...
    <>
      <section className="">
        <div className="container mx-auto px-5">
          <div className="pre-footer flex justify-between">
            <h1>Gallery</h1>
            <div className="pricing flex gap-2">
              <div className="legal flex space-x-1.5 bg-gray-200 px-2 py-1 rounded-[15px]">
                <Scale />
                <h1>Legal</h1>
              </div>
              <div className="pricing flex space-x-1.5 bg-gray-200 px-2 py-1 rounded-[15px]">
                <ChartCandlestick />
                <h1>Pricing</h1>
              </div>
            </div>
          </div>
          <footer className="bg-black -mx-6 py-4 mt-3">
            <div className="footer-container flex justify-between px-6">
              <div className="logo flex text-white items-center gap-2">
                <div className="logo-bg bg-gray-900 p-3">
                  <svg
                ...
                <h1 className="text-[30px]">Krea AI</h1>
              </div>
              <div className="sponsors flex gap-7 items-center">
                <div className="curated">
                  <h1 className="text-[30px] text-white">Curated by</h1>
                </div>
                <div className="mobbin text-white text-[30px]">
                  <h1>Mobbin</h1>
                </div>
              </div>
            </div>
